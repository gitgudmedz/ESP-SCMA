<section class="login-register" >
	...
	<div class="login-register-body">
		<h1>Welcome to your ERP Success Partners Customer Portal</h1>
		<span class="login-register-hastag">#WeGrowTogether</span>
	</div>
	<div {{#if showRegister}} class="login-register-body" {{else}} class="login-register-body-colored" {{/if}}>
		...
		{{/if}}
		<div data-cms-area="login-register-terms-policy" data-cms-area-filters="path"></div>
		<div data-view="Login.Links"></div>
	</div>
</section>
